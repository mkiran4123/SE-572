var API = (() => {
  ...
  var authLogin = () => {
    ...
    if (val.trim().length == 0) {
      ...
      document.getElementById("alertMsgInvalidlogin").style.display = "block";
      setTimeout(() => {
        document.getElementById("alertMsgInvalidlogin").style.display = "none";
      }, 3000);
      return false;
    }
    try {
        ...
        fetch("http://localhost:8080/api/v1/films/check", {
          ...
          .then((data) => {
            if (data.count == 0) {
              document.getElementById("movie-name").value = "";
              document.getElementById("movie-rating").value = "";
              document.getElementById("alertMsgUpdateError").style.display =
                "block";
              setTimeout(() => {
                document.getElementById("alertMsgUpdateError").style.display =
                  "none";
              ...
              fetch("http://localhost:8080/api/v1/films", {
                ...
                setTimeout(function () {
                  if (resp.status == 200) {
                    document.getElementById("movie-name").value = "";
                    document.getElementById("movie-rating").value = "";
                    document.getElementById("alertMsgUpdate").style.display =
                      "block";
                    setTimeout(() => {
                      document.getElementById("alertMsgUpdate").style.display =
                        "none";
                    ...
                    document.getElementById("movie-name").value = "";
                    document.getElementById("movie-rating").value = "";
                    document.getElementById("alertMsg403").style.display =
                      "block";
                    setTimeout(() => {
                      document.getElementById("alertMsg403").style.display =
                        "none";
        ...
        fetch("http://localhost:8080/api/v1/films/check", {
          ...
          .then((data) => {
            if (data.count > 0) {
              document.getElementById("movie-name").value = "";
              document.getElementById("movie-rating").value = "";
              document.getElementById("alertMsgSaveError").style.display =
                "block";
              setTimeout(() => {
                document.getElementById("alertMsgSaveError").style.display =
                  "none";
              ...
              fetch("http://localhost:8080/api/v1/films", {
                ...
                setTimeout(function () {
                  if (resp.status == 200) {
                    document.getElementById("movie-name").value = "";
                    document.getElementById("movie-rating").value = "";
                    document.getElementById("alertMsgSave").style.display =
                      "block";
                    setTimeout(() => {
                      document.getElementById("alertMsgSave").style.display =
                        "none";
